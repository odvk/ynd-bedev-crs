...
- В начале указывается протокол. Обычно это HTTP или HTTPS (от англ. HTTP Secure, «Безопасный HTTP») — расширение протокола HTTP.
...
Согласно протоколу HTTP, в URL можно использовать только латинские буквы, цифры и отдельные знаки пунктуации. Остальные символы необходимо закодировать. Таким образом пробелы превращаются в %20.
"""